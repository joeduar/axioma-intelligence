...
import { Search, Star, Shield, Filter, SlidersHorizontal } from 'lucide-react';
...
const AdvisorCard = ({ advisor }: { advisor: any }) => {
  ...
  return (
    <Link to={`/asesores/${advisor.id}`} className="group block">
      <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-gray-100 hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="relative h-44 flex items-center justify-center"
          ...
          {advisor.available && (
            <div className="absolute top-4 right-4 flex items-center gap-1.5 px-2.5 py-1 bg-white rounded-full shadow-sm border border-gray-100">
              ...
              <span className="text-[10px] font-semibold text-gray-600">Available</span>
            </div>
          )}
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-50">
            ...
            <span className="text-[10px] font-semibold text-[#10B981] group-hover:gap-2 transition-all">
              Ver perfil →
            </span>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-4">No advisors found with that criteria</p>
            <button
